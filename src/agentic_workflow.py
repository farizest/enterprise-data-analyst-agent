...
class AgentState(TypedDict):
    ...
    schema_context: str     # The table information pulled from ChromaDB
...
def generate_sql(state: AgentState):
    ...
    # 🚨 THE FIX: Explicitly instructing the AI to use PostgreSQL syntax
    ...
    Never use sqlite_master; use information_schema if you need to inspect database tables.
...
def execute_sql(state: AgentState):
    ...
    try:
        # Run the SQL query against PostgreSQL
        result = db.run(query)
